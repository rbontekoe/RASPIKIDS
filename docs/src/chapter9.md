...
!!! info "Visual Crossing: Weather Data & Weather API"
    ...
    Je key vind je, nadat je bent ingelogd onder "Key" als je klik op: ``\\``![key](assets/fig_9_34.png)
...
| 13 | Dubbelklik op de eerste "functie" en geef het de naam: `buitentemp`. ``\\``![get_actual_temp](assets/fig_9_7.png) ``\\``*Wat je hier ziet is JavaScript code. Elke uitdukking eindigt met een ";". Iets dat ingesloten is door accolades {...} verwijst naar een JSON-object.* |
